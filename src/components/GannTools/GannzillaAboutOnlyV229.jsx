...
export default function GannzillaAboutOnlyV229({ toolbarHeight = 24 }) {
  ...
  React.useEffect(() => {
    ...
    window.GANNZILLA_ABOUT_ONLY_V373 = true;
    window.__auditGannzillaAboutOnlyV373 = () => ({
      ok: true,
      build: BUILD,
    ...
    return () => {
      ...
      delete window.GANNZILLA_ABOUT_ONLY_V373;
      delete window.__auditGannzillaAboutOnlyV373;
    };
