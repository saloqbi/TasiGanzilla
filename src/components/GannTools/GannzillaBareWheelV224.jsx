...
/** Exact v391 visual restore with non-visual event storm protection. */
export default function GannzillaBareWheelV224() {
  React.useEffect(() => {
    ...
    window.GANNZILLA_BARE_WHEEL_V391_PREVIEW = true;
    const audit = () => {
    ...
    window.__auditGannzillaBareWheelV391Preview = audit;
    return () => {
      ...
      delete window.GANNZILLA_BARE_WHEEL_V391_PREVIEW;
      ...
      delete window.__auditGannzillaBareWheelV391Preview;
    };
  }, []);
  ...
  return (
    <>
      ...
      <GannzillaHideEmptyProtractorBandV388 />
