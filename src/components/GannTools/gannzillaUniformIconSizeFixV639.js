const BUILD = 639;
const STATE_KEY = '__gannzillaUniformIconSizeFixV639';
const STYLE_ID = 'gannzilla-uniform-icon-size-fix-style-v639';
const LEGACY_STYLE_IDS = [
  'gannzilla-merged-top-icon-strip-style-v638',
  'gannzilla-uniform-top-icon-strip-style-v637',
];
const PARAM = 'uniformIconSizeFix';
...
function apply(source = 'apply') {
  ...
  try {
    ...
    lastApply = {
      ...
      iconsOnly: true,
      wheelChanged: false,
      correctedControl: TIME_TRACKER_ID,
...
function install() {
  ...
  installObserver();
  timer = window.setInterval(() => schedule('uniform-icon-size-watch'), 150);

  window.GANNZILLA_UNIFORM_ICON_SIZE_FIX_V639 = true;
  window.__auditGannzillaUniformIconSizeFixV639 = () => {
