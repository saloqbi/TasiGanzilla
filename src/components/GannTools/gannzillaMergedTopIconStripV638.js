const BUILD = 638;
const STATE_KEY = '__gannzillaMergedTopIconStripV638';
const STYLE_ID = 'gannzilla-merged-top-icon-strip-style-v638';
const LEGACY_STYLE_ID = 'gannzilla-uniform-top-icon-strip-style-v637';
const PARAM = 'mergedTopIcons';
...
const TOOLBAR_WIDTH = CONTROL_SIZE * 4 + ZOOM_GROUP_WIDTH - BORDER_OVERLAP * 4;
...
function ensureStyle() {
  ...
  style.textContent = `
    ...
    #${PANEL_EYE_ID}, #${ZOOM_GROUP_ID}, #${FULLSCREEN_ID} {
...
function install() {
  ...
  installObserver();
  timer = window.setInterval(() => schedule('merged-icon-watch'), 120);

  window.GANNZILLA_MERGED_TOP_ICON_STRIP_V638 = true;
  window.__auditGannzillaMergedTopIconStripV638 = () => {
