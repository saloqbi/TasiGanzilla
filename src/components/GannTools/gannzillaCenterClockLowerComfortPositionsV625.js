const BUILD = 625;
const STATE_KEY = '__gannzillaCenterClockLowerComfortPositionsV625';
...
function install() {
  ...
  window.GANNZILLA_CENTER_CLOCK_LOWER_COMFORT_POSITIONS_V625 = true;
  window.__auditGannzillaCenterClockLowerComfortPositionsV625 = () => {
    const timeRow = document.getElementById(LOWER_TIME_ROW_ID);
    const angleRow = document.getElementById(LOWER_ANGLE_ROW_ID);
    const hijriDate = document.getElementById(LOWER_HIJRI_DATE_ID);
