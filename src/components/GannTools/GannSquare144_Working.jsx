...
const GannSquare144 = () => {
  ...
  const angleStyles = {
    45: '2px solid #00BFFF',       // أزرق سماوي
    90: '2px solid #FF8C00',       // برتقالي
    180: '2px solid #8A2BE2',      // بنفسجي
    360: '2px dashed #FF1493',     // وردي
    26.25: '2px dotted #00FF7F',   // أخضر نعناعي
    71.25: '2px dashed #FFD700',   // ذهبي
    333.75: '2px dotted #DC143C',  // أحمر غامق
    351.43: '2px dashed #1E90FF'   // أزرق داكن
  };
